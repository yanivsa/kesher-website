...
- **הבחנה נייטרלית ומשלימה בעמוד הנחיית הורים למחוננים:** במדור השאלות הנפוצות ובסכמת ה-`FAQPage`, הוסרה כל טענת עדיפות טיפולית ("מייצר השפעה ישירה ומהירה... בלי להעמיס"). במקומה הוטמעה הבחנה מאוזנת שלפיה הנחיית הורים וטיפול רגשי בילד עונים על צרכים שונים ומשלימים זה את זה — הנחיית הורים דרך המערכת המשפחתית, וטיפול רגשי דרך עולמו הפנימי של הילד, ללא עדיפות גורפת.
- **התאמה מלאה (100% Verbatim Match) בסכמת FAQPage:** הטקסט בסכמת ה-JSON-LD של `FAQPage` זהה מילה במילה לטקסט המוצג למשתמש בעמוד `GiftedParentingPage.tsx`.

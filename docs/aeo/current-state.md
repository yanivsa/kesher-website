...
| **`expertInsight`** | עמדה אישית / תובנה מקצועית של שירה. | **לא**. | **כן** — בלוק ציטוט `<blockquote>` או קופסת תובנה בתוכן. | עיצוב CSS בלבד למחלקת callout. | אין נטל. | **לא להוסיף שדה; שימוש ב-HTML סמנטי**. |

...
def publish_article(access_token, title, content_nodes):
    data = {
        ...
        "title": title,
        "author_name": "שירה סהרוני — ייעוץ זוגי וגישור",
...
if __name__ == "__main__":
    ...
    articles = [
        ...
        {
            "title": "לפתור סכסוכים משפחתיים מחוץ לבית המשפט: גישור משפחתי באשדוד",
            "content": [
                {"tag": "p", "children": [
                ...
                {"tag": "p", "children": [
                    "בחירה באפיק של ",
                    {"tag": "a", "attrs": {"href": "https://kesher.saharoni.com/services/mediation"}, "children": ["מגשרת משפחתית אשדוד"]},
                    " מאפשרת לנהל את השיח בגובה העיניים, למנוע הסלמה ולהגיע להסכמות משותפות המשרתות את כל הצדדים בצורה הוגנת ויעילה."
                ]},
                {"tag": "h3", "children": ["מדוע לבחור בגישור משפחתי?"]},
                {"tag": "p", "children": [
                ...
                {"tag": "p", "children": [
                    "לפרטים נוספים וליווי בהליכי גישור מורכבים באזור הדרום, מומלץ לפנות ל",
                    {"tag": "a", "attrs": {"href": "https://kesher.saharoni.com/services/mediation"}, "children": ["מגשרת מקצועית באשדוד"]},
                    " בעלת רקע והבנה משפטית רחבה."
                ]}
            ]
        }
    ]

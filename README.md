...
האתר הרשמי של שירה סהרוני: עורכת דין, מגשרת מוסמכת, יועצת זוגית ומנחת הורים קבוצתית ופרטנית, המתמחה בליווי משפחות והורים לילדים עם הפרעות קשב וריכוז (ADHD).

🔗 **בקרו באתר הרשמי:** [שירה סהרוני — ייעוץ זוגי, הדרכת הורים וגישור](https://kesher.saharoni.com)
...
### 🤝 [מגשרת משפחתית אשדוד](https://kesher.saharoni.com/services/mediation)
הליכי גישור משפחתי וגירושין בהסכמה, יצירת הסכמים הוגנים ויציבים מחוץ לכותלי בית המשפט תוך שמירה על טובת הילדים ובניית שותפות הורית יציבה לעתיד.
* לקריאה נוספת: [גישור משפחתי וגירושין בהסכמה באשדוד](https://kesher.saharoni.com/services/mediation)
...
* [גישור בסכסוכים אצל עסקים משפחתיים](https://kesher.saharoni.com/blog)

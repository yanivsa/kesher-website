...
const servicePages: SearchItem[] = [
  {
    ...
    body: 'ייעוץ זוגי באשדוד – ליווי וחיבור מחדש לזוגיות. ייעוץ זוגי מעשי וממוקד באשדוד או אונליין. דפוסי שיחה חוזרים, ריחוק ואינטימיות, משבר אמון, זוגיות עם ADHD וכלים מעשיים להתמודדות עם מחלוקות.',
...
const staticPages: SearchItem[] = [
  {
    ...
    body: 'שירה סהרוני, יועצת זוגית, מנחת הורים ומגשרת מוסמכת באשדוד ובאונליין. ליווי זוגות, הורים ומשפחות.',
    url: '/about',
    category: 'דפים'
  },
  {

...
const servicePages: SearchItem[] = [
  ...
  },
  {
    ...
    body: 'ייעוץ זוגי באשדוד – ליווי וחיבור מחדש לזוגיות. ייעוץ זוגי מעשי וממוקד באשדוד או אונליין. הבנת דפוסי שיחה שחוזרים, תרגול תקשורת וכלים מעשיים להתמודדות עם מחלוקות.',

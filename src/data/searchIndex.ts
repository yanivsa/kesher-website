...
const staticPages: SearchItem[] = [
  {
    ...
    body: 'יועצת זוגית ומגשרת מוסמכת באשדוד עם ניסיון של מעל 15 שנה. גישה רב-תחומית. הכשרה בייעוץ זוגי, הדרכת הורים וגישור משפחתי. מאמינה בתהליך מכבד, מעשי וממוקד.',
    url: '/about',
    category: 'דפים'
  },
  {

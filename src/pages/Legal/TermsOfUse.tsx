    ...
    <div className={styles.page}>
      ...
      <div className="container">
        <div className={styles.content}>
          ...
          <h2>תוכן האתר</h2>
          <p>המידע והמאמרים המופיעים באתר נועדו לצורך העשרה ומידע כללי בלבד. אין לראות במידע זה תחליף לייעוץ זוגי, הדרכת הורים או גישור מקצועי המותאם אישית לצרכיכם.</p>

...
const FAQ: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      question: "כמה עולה גישור גירושין?",
      answer: "עלות גישור גירושין נמוכה משמעותית מהליך משפטי. תהליך גישור טיפוסי כולל 4-8 פגישות ועולה פחות מחצי ממה שעולה ייצוג של שני עורכי דין. המחיר המדויק נקבע בהתאם למורכבות המקרה.",
      category: "גישור"
    },
    {
  ...
  return (
    <div className={styles.faq}>
      <MetaTags 
        ...
        description="תשובות לשאלות נפוצות על ייעוץ זוגי, הדרכת הורים לילדים עם ADHD, גישור גירושין בהסכמה, טיפול מקוון ועוד." 
      />

...
const faqs: FAQItem[] = [
  ...
  {
    question: "איך ייעוץ זוגי עוזר כאשר אחד מבני הזוג עם ADHD?",
    answer: "התהליך עוזר להפריד בין כוונה לבין השפעה. שכחה, דחיינות, עומס או קושי בהתנעה יכולים להיתפס כחוסר אכפתיות, אף שאינם כאלה. בונים כללים זוגיים פשוטים לניהול משימות, זמן ושיחות, בלי להפוך אחד מבני הזוג למנהל של השני.",
    category: "ייעוץ זוגי"
  },
  // גישור
  {
  ...
  return (
    <div className={styles.faq}>
      <MetaTags 
        ...
        description="תשובות על הכנה לחתונה, זוגיות עם ADHD, הכנה לכיתה א' לילדים עם ADHD, ייעוץ זוגי, הדרכת הורים וגישור."
      />

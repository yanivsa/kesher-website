  ...
  "@graph": [
    {
      ...
      "name": "אודות שירה סהרוני | יועצת זוגית ומנחת הורים",
      "description": "הכירו את שירה סהרוני — יועצת זוגית ומנחת הורים באשדוד ובאונליין.",
      ...
      "mainEntity": {
        ...
        "description": "שירה סהרוני היא יועצת זוגית ומנחת הורים, המלווה זוגות ומשפחות באשדוד ובאונליין.",
        "url": `${SITE_CONFIG.url}/about`,
        "sameAs": [
...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className={styles.page}>
      ...
      <MetaTags 
        title="אודות שירה סהרוני | יועצת זוגית ומנחת הורים"
        description="הכירו את שירה סהרוני — יועצת זוגית ומנחת הורים באשדוד ובאונליין."
      ...
      <section className={styles.story}>
        <div className={`container ${styles.storyGrid}`}>
          ...
          <div className={styles.storyContent}>
            ...
            <h2>מעולמות הניהול והניתוח לעולמות ההנחיה, הייעוץ והחינוך</h2>
            <p className={styles.lead}>
              אני יועצת זוגית ומנחת הורים, שבחרה להפנות את היכולת לנתח מצבים מורכבים, להקשיב לכל הצדדים ולבנות הסכמות — לעבודה עם זוגות, הורים ומשפחות.
            </p>
            <p>
            ...
            <p>
              בעבודה שלי אני משלבת הקשבה, בהירות וכלים שאפשר ליישם בבית. לצד ייעוץ זוגי והנחיית הורים, אני מעניקה מקום מרכזי למשפחות לילדים מחוננים, לילדים עם ADHD, למעברים חינוכיים ולמשפחות בתהליך עלייה או חזרה לישראל.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className={styles.belief}>
        <div className="container">
          <div className={styles.beliefContent}>
            ...
            <p>
              אני מאמינה שזוגיות מיטיבה וחזקה היא הבסיס להורות יציבה, ולהיפך. הקשרים בתוך המשפחה שזורים זה בזה, ולכן הגישה שלי מסתכלת על המערכת כולה: כשאנחנו מדייקים את ההורות שלנו, אנחנו מפנים מקום לזוגיות קרובה יותר, וכשאנחנו מטפלים בזוגיות, אנחנו בונים קומה נוספת של ביטחון עבור הילדים.
            </p>
            <p>

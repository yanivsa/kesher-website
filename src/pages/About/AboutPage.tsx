        ...
        <div className={`container ${styles.storyGrid}`}>
          ...
          <div className={styles.storyContent}>
            ...
            <p className={styles.lead}>
              אני עורכת דין בהכשרתי ומגשרת מוסמכת, שבחרתי להפנות את היכולת לנתח מצבים מורכבים, להקשיב לכל הצדדים ולבנות הסכמות — לעבודה עם זוגות, הורים ומשפחות.
            </p>
            <p>
      ...
      <section className={styles.belief}>
        <div className="container">
          <div className={styles.beliefContent}>
            ...
            <p>
              שינוי לא מתחיל כשמישהו במשפחה „מתוקן”. הוא מתחיל כשאפשר להבין את הדפוס, לדבר אחרת ולבחור צעד קטן שאפשר לעמוד בו.
            </p>
            <p>
              התפקיד שלי הוא לעזור לכם ליצור בהירות, חיבור ושיתוף פעולה — בין בני זוג, בין הורים לילדים ובין המשפחה למסגרות שסביבה.
            </p>
            <Link to={SITE_CONFIG.links.appointment}>לקבוע פגישת ייעוץ</Link>
          </div>
        </div>
      </section>
    </div>

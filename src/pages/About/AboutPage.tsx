    ...
    <div className={styles.page}>
      ...
      <section className={styles.extraContent}>
        <div className="container">
          ...
          <p>
            אני מביאה לקליניקה רקע מקצועי רחב והכשרה מקיפה בתחומי הטיפול והייעוץ, המאפשרים לי להעניק ליווי מבוסס ומקצועי.
            <br />
            <strong>[TODO: להוסיף פירוט תארים אקדמיים, מוסדות הכשרה ותעודות מקצועיות של שירה סהרוני]</strong>
          </p>
          <br />

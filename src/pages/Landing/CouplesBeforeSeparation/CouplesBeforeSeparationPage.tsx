...
const FAQS: FAQItem[] = [
  ...
  {
    q: 'מה תפקידך בבניית הסכמות פרידה?',
    a: 'התהליך מתמקד בבירור רגשי, תקשורתי ובניית הסכמות הדדיות מכבדות מתוך שיתוף פעולה. כמגשרת מוסמכת ויועצת זוגית, מטרתי לסייע לכם להגיע להבנות ענייניות בשלום בית או בפרידה מכבדת לטובת הילדים.',
  },
  {
...
const CouplesBeforeSeparationPage: React.FC = () => {
  ...
  return (
    <main id="main-content" className={styles.page}>
      <MetaTags
        title="בירור זוגי לפני החלטות כבדות | שירה סהרוני – ייעוץ זוגי"
        ...
        canonical={`${SITE_CONFIG.url}/services/couples/before-separation`}
      />

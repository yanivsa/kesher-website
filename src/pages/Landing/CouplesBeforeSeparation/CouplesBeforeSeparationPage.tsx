...
const FAQS: FAQItem[] = [
  ...
  {
    q: 'האם את מעורבת גם בצד המשפטי או בהסכמי פרידה?',
    a: 'הייעוץ אינו מהווה ייעוץ משפטי ואינו תחליף לייצוג משפטי. מטרתו היא בירור רגשי, זוגי ותקשורתי, וכן בניית הסכמות ענייניות במידה ופונים לנתיב של פרידה.',
  },
  {

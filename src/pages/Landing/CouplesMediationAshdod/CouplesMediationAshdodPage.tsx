...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'גישור מתקיים אך ורק מרצון חופשי. שירה סהרוני, כעורכת דין בהכשרתה ומגשרת מוסמכת, מקפידה על שוויון מלא ועל כך שאף צד לא יחתום או יסכים למה שאינו שלם איתו.',
  },
  {
      ...
      <section className={styles.sectionAlt}>
        <div className="container">
          <div className={styles.sectionHeader}>
            <h2>כשהמחלוקת מעמיקה וכל שיחה הופכת למבוי סתום</h2>
            <p>
      ...
      <section className={styles.section}>
        <div className="container">
          <div className={styles.hopeBox}>
            <h2>מחלוקת עמוקה אינה חייבת להפוך למלחמה</h2>
        ...
        <div className="container">
          <div className={styles.resistanceBox}>
            ...
            <div className={styles.resistanceBody}>
              ...
              <p>
                זה לא קורה בגישור. שירה סהרוני, כעורכת דין בהכשרתה ומגשרת מוסמכת, מחויבת לניטרליות מוחלטת ולהגנה על זכותו של כל צד להשמיע את דעתו ולהסכים רק לפתרונות הוגנים ושלמים עבורו.
              </p>
              <p>
      ...
      <section className={styles.sectionAlt}>
        <div className={`container ${styles.aboutGrid}`}>
          ...
          <div className={styles.aboutContent}>
            <h2>שילוב של ראייה משפטית סדורה לצד רגישות לדינמיקה הזוגית</h2>
            <span className={styles.aboutRole}>
              שירה סהרוני | עורכת דין בהכשרתה, מגשרת מוסמכת ויועצת זוגית
            </span>
            <p>
              כעורכת דין בהכשרתי ומגשרת מוסמכת, אני מביאה לחדר הגישור שילוב של הבנה משפטית מעמיקה, יסודיות בהגדרת הסכמות, ורגישות אנושית רבה למורכבות הרגשית של בני הזוג.
            </p>
            <p>

...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'מומלץ להגיע יחד, משום שהייעוץ מתמקד בתקשורת ובדפוסים שבין בני הזוג. אם אחד מבני הזוג עדיין לא מוכן להשתתף, אפשר להתחיל לבד ולבחון מה ניתן לשנות בדרך שבה מגיבים ומתקשרים; לעיתים הצד השני מצטרף בהמשך.',
  },
  {

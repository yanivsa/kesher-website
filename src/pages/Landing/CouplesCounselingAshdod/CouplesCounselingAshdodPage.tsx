    ...
    <main id="main-content" className={styles.page}>
        ...
        <div className="container">
          <div className={styles.hopeBox}>
            ...
            <div className={styles.hopeContent}>
              ...
              <p>
                מתוך התהליך מקבלים כלים מעשיים לפתיחת שיחה אחרת, להקשבה ללא התגוננות ולתרגול צעד אחד קטן בכל פעם בבית — כדי להחזיר את הביטחון והשקט לקשר.
              </p>
            </div>
      ...
      <section className={styles.sectionAlt}>
        <div className={`container ${styles.aboutGrid}`}>
          ...
          <div className={styles.aboutContent}>
            ...
            <p>
              אני מאמינה כי גם כשהתקשורת עמוסה ומורכבת, עבודה מסודרת וממוקדת במרחב בטוח מאפשרת לעצור את ההסלמה ולהחזיר את השקט והאמון.
            </p>
            ...
            <ul className={styles.trustPointsList}>
              ...
              <li>
                ...
                <span>מבינים בדיוק איפה השיחות נתקעות ומה מפעיל את הריחוק והכעס.</span>
              </li>
              <li>
      ...
      <section className={styles.closingCta}>
        <div className="container">
          ...
          <p>התחלה קצרה ודיסקרטית להבנת הדפוס והחזרת השקט ליחסים.</p>

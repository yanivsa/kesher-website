...
const points = [
  {
    icon: <FiAward />,
    title: 'הסתכלות משולבת',
    description: 'השילוב בין ייעוץ זוגי והנחיית הורים מאפשר לי לראות את כל התמונה ולתת מענה שלם ומקיף למשפחה.'
  },
  {
    icon: <FiHeart />,
    title: 'גישה אנושית ורגישה',
    description: 'אני מאמינה שבתוך כל קונפליקט מסתתר רצון לחיבור. הליווי שלי מבוסס על חמלה, הקשבה וביטחון רגשי.'
  },
  {
    icon: <FiTrendingUp />,
    title: 'כלים פרקטיים ליומיום',
    description: 'לא רק מדברים, אלא עושים. תקבלו ממני "שיעורי בית" וכלים יישומיים שתוכלו להתחיל לתרגל וליישם כבר מהמפגשים הראשונים.'
  },
  {
    icon: <FiShield />,
    title: 'דיסקרטיות ומקצועיות',
    description: 'מחויבות מלאה לפרטיות שלכם ולסטנדרטים המקצועיים הגבוהים ביותר בעולם הייעוץ והטיפול.'
  }
];

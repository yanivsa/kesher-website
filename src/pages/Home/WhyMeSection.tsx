...
const points = [
  {
    ...
    description: 'ההכשרה המשפטית והגישורית מחזקת את היכולת למפות מצבים מורכבים, להקשיב לכל הצדדים ולבנות הסכמות ברורות.'
  },
  {
    icon: <FiHeart />,
  ...
  },
  {
    ...
    description: 'מחויבות מלאה לפרטיות שלכם ולסטנדרטים מקצועיים גבוהים בעולמות הייעוץ, ההנחיה והגישור.'
  }
];

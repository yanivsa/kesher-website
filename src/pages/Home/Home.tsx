      ...
      <main id="main-content" className={styles.main}>
        <section id="top" className={styles.hero}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.heroLead}>
              שירה סהרוני היא יועצת זוגית, מנחת הורים ומגשרת מוסמכת באשדוד ובאונליין.
              כשהשיחות נתקעות והעומס גדל, הליווי עוזר לזהות את הדפוס שחוזר ולבחור צעדים מעשיים שאפשר ליישם בזוגיות ובבית.
            </p>
        ...
        <section id="faq" className={`${styles.section} ${styles.faqSection} ${styles.revealSection}`}>
          ...
          <div className={styles.faqGrid}>
            ...
            <article className={styles.faqCard}>
              <h3 className={styles.faqQuestion}>מה עושים אם בן או בת הזוג לא רוצים להגיע לייעוץ?</h3>
              <p className={styles.faqAnswer}>אפשר וכדאי להתחיל לבד. פעמים רבות, מספיק שצד אחד עושה שינוי בדרך שבה הוא מגיב או מתקשר כדי לייצר תנועה חדשה בקשר. בנוסף, ההתחלה של אחד מבני הזוג מעודדת לא פעם את הצד השני להצטרף בהמשך.</p>
            </article>
            <article className={styles.faqCard}>

      ...
      <section className={styles.approach}>
        <div className="container">
          <div className={styles.approachContent}>
            ...
            <p>המטרה היא לא להכריע מי צודק. נבדוק איך השיחה מתנהלת, מה כל אחד שומע ברגעים טעונים ומה יעזור לכם להישאר באותה שיחה בלי להסלים או להתרחק.</p>
            ...
            <div className={styles.geoResearchNote}>
              <p>💡 <strong>עובדה מחקרית:</strong> מחקרים בתחום הדינמיקה הזוגית מראים כי כ-69% מהקונפליקטים הזוגיים נובעים מהבדלי אישיות תפיסתיים ואינם ניתנים לפתרון מוחלט. מטרת הייעוץ הזוגי אינה "לפתור" את כל הוויכוחים, אלא לבנות שפה משותפת ומנגנון ויסות שמונע הסלמה.</p>
            </div>
          </div>
        </div>
      </section>

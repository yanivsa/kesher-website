      ...
      <section className={styles.onlineSection}>
        <div className="container">
          <div className={styles.approachContent}>
            ...
            <p>אם קשה לכם להגיע לקליניקה באשדוד בגלל מרחק, שעות עבודה, מגורים בחו״ל או תקופה של רילוקיישן, אפשר לקיים את פגישת הייעוץ הזוגי גם אונליין בזום. הפגישה נמשכת 50 דקות, ובמהלכה עובדים על אותם נושאים שמביאים זוגות לייעוץ: דפוסי שיחה שחוזרים על עצמם, קונפליקטים, ריחוק, תיאום ציפיות וקבלת החלטות משותפת.</p>
            ...
            <h3 style={{ marginTop: '2rem', marginBottom: '0.75rem' }}>מתי הפורמט יכול להיות שימושי?</h3>
            <p>אונליין יכול להיות פתרון מעשי לזוגות שאינם גרים באשדוד, לזוגות שנמצאים בתקופת מעבר או רילוקיישן, או כששגרת החיים מקשה על הגעה קבועה לקליניקה. אם יש נסיבות שמקשות לקיים שיחה זוגית בטוחה ופרטית מהבית, אפשר לברר מראש מהו הפורמט המתאים יותר.</p>

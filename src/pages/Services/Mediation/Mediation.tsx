...
const Mediation: React.FC = () => {
  const content = (
    <div className={styles.serviceContent}>
      ...
      <section className={styles.segment}>
        <h2>הערך המוסף שלי כמגשרת ועו\"ד</h2>
        <p>
          אני מביאה איתי ידע משפטי מעמיק כעורכת דין, לצד כלים רגשיים מעולם הטיפול. 
          זה מאפשר לי לנהל את המורכבות של הגישור ברגישות רבה מבלי לפספס אף פרט משפטי קריטי.
        </p>
      </section>
    </div>
  );

      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'הנחיית הורים לילדים מחוננים מספקת כלים מעשיים להתמודדות עם הפער בין היכולת הקוגניטיבית הגבוהה לבין הבשלות הרגשית, הפרפקציוניזם, קשיי הוויסות והאתגרים החברתיים. מומלץ לפנות כאשר מזהים תסכול סביב משימות יומיום, התפרצויות זעם או לקראת כניסה למסגרת מחוננים.'
          }
        },
        {
          '@type': 'Question',
          name: 'איך מתמודדים עם שילוב של מחוננות ו-ADHD?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'במקרים של כפל ייחודיות (2e), אצל חלק מהילדים היכולת הגבוהה עשויה להסוות קשיי קשב, או שפערים בתפקודים ניהוליים יוצרים תסכול. בהנחיית ההורים מפרידים בין מוטיבציה לקשיי התארגנות ובונים עוגנים פשוטים לניהול זמן, משימות ושגרה בלי מאבקי כוח.'
          }
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'הנחיית הורים וטיפול רגשי בילד עונים על צרכים שונים ומשלימים זה את זה. הנחיית הורים פועלת דרך המערכת המשפחתית, שגרת הבית והסביבה היומיומית, ומעניקה להורים כלים מעשיים לתמיכה, הצבת גבולות וויסות. טיפול רגשי, לעומת זאת, מתמקד בעולמו הפנימי של הילד ובקשר הישיר עמו. אף גישה אינה עדיפה באופן גורף; הבחירה תלויה במוקד הקושי ובצורכי המשפחה, ולעיתים קרובות שתי הדרכים פועלות במקביל ובתיאום.'
          }
        }
      ]
    }
    ...
    <div className={styles.page}>
        ...
        <div className="container">
          ...
          <div className={styles.cardGrid}>
            ...
            <article className={styles.card}>
              ...
              <p>בניית תמיכה מותאמת כאשר אצל הילד מתקיימים במקביל יכולת גבוהה ופערים בהתארגנות, ויסות, ניהול זמן והתמדה.</p>
            </article>
          </div>
        </div>
      </section>
      ...
      <section className={styles.softSection}>
        <div className="container">
          ...
          <div className={styles.cardGrid}>
            <article className={styles.card}>
              <h3>מהי הנחיית הורים לילדים מחוננים ומתי כדאי לפנות?</h3>
            ...
            <article className={styles.card}>
              ...
              <p>במקרים של כפל ייחודיות (2e), אצל חלק מהילדים היכולת הגבוהה עשויה להסוות קשיי קשב, או שפערים בתפקודים ניהוליים יוצרים תסכול. בהנחיית ההורים מפרידים בין מוטיבציה לקשיי התארגנות ובונים עוגנים פשוטים לניהול זמן, משימות ושגרה בלי מאבקי כוח.</p>
            </article>
            <article className={styles.card}>
              <h3>מה ההבדל בין הנחיית הורים לטיפול רגשי בילד?</h3>
              <p>הנחיית הורים וטיפול רגשי בילד עונים על צרכים שונים ומשלימים זה את זה. הנחיית הורים פועלת דרך המערכת המשפחתית, שגרת הבית והסביבה היומיומית, ומעניקה להורים כלים מעשיים לתמיכה, הצבת גבולות וויסות. טיפול רגשי, לעומת זאת, מתמקד בעולמו הפנימי של הילד ובקשר הישיר עמו. אף גישה אינה עדיפה באופן גורף; הבחירה תלויה במוקד הקושי ובצורכי המשפחה, ולעיתים קרובות שתי הדרכים פועלות במקביל ובתיאום.</p>
            </article>
          </div>
        </div>
      </section>
